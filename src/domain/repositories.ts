...
export interface CaseRepository {
  ...
  findByMarketHashNames(marketHashNames: string[]): Promise<Map<string, CaseItem>>;
...
export interface PriceSnapshotRepository {
  ...
  findClosestBeforeMany(caseIds: string[], date: Date): Promise<Map<string, PriceSnapshot>>;
