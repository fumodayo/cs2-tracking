...
export function SellSelectedMetrics({ metrics, formatCurrency }: SellSelectedMetricsProps) {
  return (
    <div className="flex shrink-0 flex-col justify-between gap-6 border-t border-stone-800/80 pt-4 lg:col-span-4 lg:border-t-0 lg:border-l lg:pt-0 lg:pl-6 xl:col-span-3">
      <div className="space-y-4">
        <h3 className="font-mono text-xs font-bold tracking-wider text-stone-400 uppercase">
          Thống kê phiên bán
        </h3>

        <div className="from-card/60 to-card/20 space-y-4.5 rounded-[5px] border border-stone-800 bg-gradient-to-b p-4.5 shadow-md backdrop-blur-md dark:shadow-[0_4px_24px_rgba(0,0,0,0.4)]">
          {/* Tổng vốn */}
          <div className="flex items-center justify-between text-xs">
            <span className="w-min font-mono text-[10px] leading-tight font-medium tracking-wider break-words text-stone-500 uppercase">
              Tổng vốn thu hồi
            </span>
          ...
          <div
            className={`rounded-[5px] border p-5 transition-all duration-300 ${
              metrics.profitAmount >= 0
                ? 'border-emerald-500/20 bg-emerald-500/[0.04] shadow-[0_0_15px_rgba(16,185,129,0.02)] hover:border-emerald-500/30 dark:bg-emerald-500/10'
                : 'border-red-500/20 bg-red-500/[0.04] shadow-[0_0_15px_rgba(239,68,68,0.02)] hover:border-red-500/30 dark:bg-red-500/10'
            }`}
          >
            <span className="block w-32 font-mono text-[9px] leading-normal font-bold tracking-widest text-stone-500 uppercase">
