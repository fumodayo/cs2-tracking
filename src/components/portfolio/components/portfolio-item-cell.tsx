      ...
      <div className="min-w-0">
        ...
        <div className="mt-1 flex flex-wrap items-center gap-1.5">
          ...
          {item.sourceType === 'manual' ? (
            <span className="border-accent/30 bg-accent/10 text-accent inline-flex rounded border px-1.5 py-0.5 text-[10px] font-semibold tracking-wider uppercase">
    ...
    <>
      {isMobile ? (
        ...
        <HoverCard.Root
          ...
          closeDelay={150}
        >
          <HoverCard.Trigger asChild>{triggerContent}</HoverCard.Trigger>
          <HoverCard.Portal>
            <HoverCard.Content
              side="right"
              sideOffset={12}
