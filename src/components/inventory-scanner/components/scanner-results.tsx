  ...
  return (
    <div className="space-y-6">
      ...
      {totalUnfilteredItemsCount > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-stone-800 bg-stone-900/30 py-16 text-center px-4">
          <ShoppingBag className="mb-4 size-10 text-stone-600" />
          <p className="text-lg font-medium text-stone-300">
            {t("inventoryScanner.noItemsFound")}
          </p>
          <p className="mt-1 text-sm text-stone-500 max-w-xs mb-6">
